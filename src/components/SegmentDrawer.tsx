        ...
        <div className="p-4 pt-5">
          ...
          <div
            ...
            className={`transition-all overflow-hidden pb-2 ${segmentTypes !== "Click" &&
              ...
              } px-3 py-2 cursor-pointer rounded-xl ${segmentTypes === "Click"
          ...
          >
            <div className="flex">
              ...
              <span
                className={`font-bold ${segmentTypes === "Click" && "text-blue-600"
                  }`}
              >
                点选模式
              </span>
            ...
            <div className="flex justify-between mx-5 my-3">
              ...
              >
                <p
                  className={`w-8 h-7 text-3xl leading-7 text-center align-middle rounded-lg mb-1 ${userNegClickBool
                    ? "outline outline-1"
                ...
                <p
                  className={`text-xs font-bold ${!userNegClickBool && "text-blue-600"
                    }`}
                >
                  添加区域
                </p>
              ...
              >
                <p
                  className={`w-8 h-7 text-3xl leading-6 text-center align-middle rounded-lg mb-1 ${userNegClickBool
                    ? "bg-blue-600 text-white"
                    : "outline outline-1"
                    }`}
                >
          ...
          <div
            ...
            className={`transition-all overflow-hidden ${segmentTypes !== "Box" &&
              ...
              } my-2 rounded-xl px-4 py-2 cursor-pointer ${segmentTypes === "Box"
                ? "outline-blue-700 outline outline-[2.5px]"
                : "outline outline-gray-200"
              } ${isCutOut && "hidden"}`}
            onMouseEnter={() => {
          ...
          >
            <div className="flex">
              ...
              <span
                className={`pl-2 font-bold ${segmentTypes === "Box" && "text-blue-600"
                  }`}
              >
                框选模式
              </span>
          ...
          >
            ...
            {isCutOut === false && visibleStickerHover && (
              <Animate isMounted={isCutOutMounted}>
                <p className="my-2 text-xs opacity-70">查看已标区域</p>
              </Animate>
            )}
            {isCutOut && (
              <>
